...
const designProcess = [
  { step: "01", title: "Free Visit & Estimate", text: "We visit your property, walk around the garden, discuss what you need, and give you an honest, no-obligation estimate — no hidden extras." },
  { step: "02", title: "Schedule Your Service", text: "We agree on dates that work for you — whether it's a one-off job or a regular maintenance visit. We work around your schedule." },
  { step: "03", title: "We Get To Work", text: "The team arrives on time and gets straight to work. We bring all the tools and equipment needed for the job." },
  { step: "04", title: "Clean & Tidy Finish", text: "We never leave a mess. All waste is cleared, hedges are shaped neatly, lawns are edged, and your garden is left looking its best." },
  { step: "05", title: "Final Check", text: "We walk you through the finished work, make sure you're completely happy, and offer advice on keeping everything maintained." },
  { step: "06", title: "Regular Visits", text: "If you'd like us to come back regularly, we'll set up a schedule that keeps your garden in top condition all year round." },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="reveal-item mb-5 leading-relaxed" style={{ color: "var(--warm-grey)", fontSize: "15px" }}>
                We specialise in keeping gardens beautiful across {client.basedIn} — from regular lawn mowing and hedge trimming to full garden clearances, fencing, and seasonal planting. Every job is done to the highest standard with care and attention to detail.
              </p>
              <p className="reveal-item mb-5 leading-relaxed" style={{ color: "var(--warm-grey)", fontSize: "15px" }}>
                {client.founderName} and the team handle every job personally — no subcontractors, no shortcuts. We turn up when we say we will and leave your garden looking immaculate.
              </p>
              <p className="reveal-item leading-relaxed" style={{ color: "var(--warm-grey)", fontSize: "15px" }}>
                Whether you need a one-off garden rescue, regular maintenance visits, new fencing, or a complete garden clearance — we bring the same level of care and reliability to every job.
              </p>
